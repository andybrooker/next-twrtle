...
import { Typography, Skeleton, Avatar, Box, useTheme, Link, TableRow, TableCell } from '@mui/material'
...
export default function AuthorRow({ username }) {
    ...
    return (
            <TableRow>
                <TableCell>
                    <AuthorProfileImage author={authorQuery.data} isLoading={authorQuery.isLoading} />
                </TableCell>
                <TableCell>
                    <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                        <AuthorName author={authorQuery.data} isLoading={authorQuery.isLoading} />
                        <AuthorUsername author={authorQuery.data} isLoading={authorQuery.isLoading} />
                    </Box>
...
const AuthorName = ({ author, isLoading }) => {
    ...
    return (
        <Typography sx={{ fontWeight: 400, m: 0, p: 0 }} variant="medium" component="p">
            {isLoading ?
